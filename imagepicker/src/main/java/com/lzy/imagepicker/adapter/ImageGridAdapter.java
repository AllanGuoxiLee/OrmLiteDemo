...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Activity activity, ArrayList<ImageItem> images, OnCameraClickListener onCameraClickListener) {
        this.mActivity = activity;
        if (images == null || images.size() == 0) this.images = new ArrayList<>();
        else this.images = images;
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if ((mActivity instanceof ImageBaseActivity) && !((ImageBaseActivity) mActivity).checkPermission(Manifest.permission.CAMERA)) {
